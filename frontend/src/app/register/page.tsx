    ...
    <div className="flex min-h-screen w-full bg-app font-inter overflow-hidden">
      ...
      <div className="w-full lg:w-[480px] xl:w-[500px] bg-[#0e1424]/95 backdrop-blur-2xl flex flex-col min-h-screen shrink-0 relative z-20 border-r border-white/5 lg:shadow-[20px_0_50px_rgba(0,0,0,0.5)]">
        ...
        <div className="flex-1 flex flex-col justify-center px-8 sm:px-12 lg:px-14 py-6 md:py-12 relative z-10">
          ...
          <h2 className="text-xl md:text-2xl text-white text-center mb-6 md:mb-10 font-bold font-clash tracking-wide">Create your account</h2>
          
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 md:gap-6">
            <div className="relative">
              <label className="text-xs text-zinc-400 font-bold uppercase tracking-wider mb-2 block">Full Name</label>
              <input
                type="text"
                required
                value={name}
            ...
            <div className="flex items-center justify-center my-2 md:my-4 opacity-50">
              ...
              <span className="px-4 text-[11px] font-bold text-zinc-500 tracking-wider">JOIN NOW</span>
              <div className="h-px bg-white/10 flex-1"></div>
            </div>
            ...
            >
              {isLoading ? <Loader2 className="w-5 h-5 animate-spin text-white" /> : 'Sign Up'}
            </button>
          </form>
        ...
        <div className="px-8 sm:px-12 lg:px-14 pb-4 md:pb-8 pt-4 md:pt-6 border-t border-white/5 bg-[#0a0f1c]/50 backdrop-blur-md">
          <p className="text-sm text-zinc-400 font-medium text-center">
            ...
            <Link href="/login" className="text-cyan-400 font-bold hover:text-cyan-300 hover:underline ml-1 transition-colors">
              Sign in back
            </Link>
          </p>
        </div>

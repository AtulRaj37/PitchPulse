...
async function main() {
    ...
    const players = [
        // Team 1 Players
        { id: 'player-rv', name: 'Rohit Verma', teamId: team1.id, role: client_1.PlayerRole.BATSMAN, jerseyNumber: 45 },
        { id: 'player-sk', name: 'Suresh Kumar', teamId: team1.id, role: client_1.PlayerRole.ALL_ROUNDER, jerseyNumber: 12 },
        { id: 'player-vk', name: 'Virat Kohli', teamId: team1.id, role: client_1.PlayerRole.BATSMAN, jerseyNumber: 18 },
        { id: 'player-rj', name: 'Ravichandran Jadeja', teamId: team1.id, role: client_1.PlayerRole.ALL_ROUNDER, jerseyNumber: 8 },
        { id: 'player-bk', name: 'Bhuvneshwar Kumar', teamId: team1.id, role: client_1.PlayerRole.BOWLER, jerseyNumber: 15 },
        { id: 'player-jb', name: 'Jasprit Bumrah', teamId: team1.id, role: client_1.PlayerRole.BOWLER, jerseyNumber: 93 },
        { id: 'player-ms', name: 'Mahendra Singh Dhoni', teamId: team1.id, role: client_1.PlayerRole.WICKET_KEEPER_BATSMAN, jerseyNumber: 7 },
        { id: 'player-hp', name: 'Hardik Pandya', teamId: team1.id, role: client_1.PlayerRole.ALL_ROUNDER, jerseyNumber: 33 },
        { id: 'player-rp', name: 'Rohit Sharma', teamId: team1.id, role: client_1.PlayerRole.BATSMAN, jerseyNumber: 17 },
        { id: 'player-sk2', name: 'Shubman Gill', teamId: team1.id, role: client_1.PlayerRole.BATSMAN, jerseyNumber: 77 },
        { id: 'player-ah', name: 'Ashwin Hasan', teamId: team1.id, role: client_1.PlayerRole.BOWLER, jerseyNumber: 99 },
        // Team 2 Players
        { id: 'player-rl', name: 'Rishabh Pant', teamId: team2.id, role: client_1.PlayerRole.WICKET_KEEPER_BATSMAN, jerseyNumber: 17 },
        { id: 'player-ak', name: 'Axar Patel', teamId: team2.id, role: client_1.PlayerRole.ALL_ROUNDER, jerseyNumber: 20 },
        { id: 'player-dk', name: 'Devdutt Padikkal', teamId: team2.id, role: client_1.PlayerRole.BATSMAN, jerseyNumber: 72 },
        { id: 'player-sk3', name: 'Shreyas Iyer', teamId: team2.id, role: client_1.PlayerRole.BATSMAN, jerseyNumber: 41 },
        { id: 'player-kp', name: 'Kuldeep Yadav', teamId: team2.id, role: client_1.PlayerRole.BOWLER, jerseyNumber: 23 },
        { id: 'player-ns', name: 'Naveen Kumar', teamId: team2.id, role: client_1.PlayerRole.BOWLER, jerseyNumber: 45 },
        { id: 'player-pr', name: 'Prithvi Shaw', teamId: team2.id, role: client_1.PlayerRole.BATSMAN, jerseyNumber: 54 },
        { id: 'player-ls', name: 'Lalit Yadav', teamId: team2.id, role: client_1.PlayerRole.ALL_ROUNDER, jerseyNumber: 62 },
        { id: 'player-ms2', name: 'Mohammed Shami', teamId: team2.id, role: client_1.PlayerRole.BOWLER, jerseyNumber: 11 },
        { id: 'player-ys', name: 'Yash Dhull', teamId: team2.id, role: client_1.PlayerRole.BATSMAN, jerseyNumber: 26 },
        { id: 'player-ri', name: 'Ripal Patel', teamId: team2.id, role: client_1.PlayerRole.BOWLER, jerseyNumber: 88 },
    ];
    ...
    const tournament = await prisma.tournament.upsert({
        ...
        create: {
            ...
            format: client_1.MatchFormat.T20,
            overs: 20,
            maxTeams: 8,
            minTeams: 4,
